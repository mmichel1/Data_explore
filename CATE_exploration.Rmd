...
if (Read_Fresh_from_File)  {
  ...
  saveRDS(rawframe, file = paste(rel_fpath_output , filename2, ".rData"))
  saveRDS(rawframe, file = paste(rel_fpath_output , filename3, ".rData"))
  saveRDS(rawframe, file = paste(rel_fpath_output , filename4, ".rData"))
  saveRDS(rawframe, file = paste(rel_fpath_output , filename5, ".rData"))
  saveRDS(rawframe, file = paste(rel_fpath_output , filename6, ".rData"))
  saveRDS(rawframe, file = paste(rel_fpath_output , filename7, ".rData"))
  ...
  rawframe2 <- readRDS(file = paste(rel_fpath_output , filename2, ".rData"))
  rawframe3 <- readRDS(file = paste(rel_fpath_output , filename3, ".rData"))
  rawframe4 <- readRDS(file = paste(rel_fpath_output , filename4, ".rData"))
  rawframe5 <- readRDS(file = paste(rel_fpath_output , filename5, ".rData"))
  rawframe6 <- readRDS(file = paste(rel_fpath_output , filename6, ".rData"))
  rawframe7 <- readRDS(file = paste(rel_fpath_output , filename7, ".rData"))
