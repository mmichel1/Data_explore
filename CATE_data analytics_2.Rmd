...
if (tableau_output) {
  ...
  Messung$DMW_viol[(abs(Messung$DMW_norm)>1.05) & (abs(Messung$DMW_norm)<=1.1)] <- "erhöht"
  ...
  Messdaten_Sollwerte$meddev[abs(Messdaten_Sollwerte$DMW_median_norm)>0.5] <- "erhöht"
  ...
  Messdaten_Sollwerte$IQRdev[Messdaten_Sollwerte$DMW_IQR_norm>0.4] <- "erhöht"  
...
train_o <- frame87_cleanoutl[train_index, ]#-(1:1)]       # Zufallsvektor definiert die Trainingsdaten
test_o  <- frame87_cleanoutl[-train_index, ]#-(1:1)]       # ..das Komplement die Testdaten
...
# result is vector of mean values of the resprective nodes
yhat_prob <- fn_norm_zo(yhat)        # normalize predicte values
yhat_label <- as.factor(prob_to_class(yhat_prob, 0.70))
...
RF_mod2 <- randomForest(x=select(train, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), y=as.factor(train$firstsecondpass_scen), cutoff=c(0.3,0.7), importance=TRUE, ntree=500)
RF_mod2
plot(RF_mod2)
#summary(RF_mod2)
...
if (tenfold) {
  ...
  RF_mod3 <- train(select(train, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), as.factor(train$firstsecondpass_scen), method = "rf", tuneLength = 12, ntree = 400, trcontrol = ctrl.1)
...
#summary(RF_mod3)
print(varImp(RF_mod3), top = 30)
plot(varImp(RF_mod3), top = 30)
   
library(e1071)
# Evaluation with test data set
yhat <- predict(RF_mod3, select(test, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), type="prob")[,"1"] # take secend column of probabilities
...
if (fivefold) {
  ...
  RF_mod4 <- train(select(train, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), as.factor(train$firstsecondpass_scen), method = "rf", tuneLength = 12, ntree = 400, trcontrol = ctrl.2 )
...
#summary(RF_mod4)
print(varImp(RF_mod4), top = 30)
plot(varImp(RF_mod4), top = 30)

library(e1071)
# Evaluation with test data set
yhat <- predict(RF_mod4, select(test, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), type="prob")[,"1"] # take secend column of probabilities
...
if (threefold) {
  ...
  RF_mod5 <- train(select(train, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), as.factor(train$firstsecondpass_scen), method = "rf", tuneLength = 12, ntree = 400, trcontrol = ctrl.3 )
...
#summary(RF_mod5)
print(varImp(RF_mod5), top = 30)
plot(varImp(RF_mod5), top = 30)
   
library(e1071)
# Evaluation with test data set
yhat <- predict(RF_mod5, select(test, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass)), type="prob")[,"1"] # take secend column of probabilities
...
further investigation with Adaptive Lasso:
...
cv.lasso_mod <- cv.glmnet(as.matrix(select(train_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), train_o$firstsecondpass_scen, alpha=1, parallel=TRUE, standardize=TRUE, type.measure='auc')
...
if (Adaptive_Lasso) {
  ...
  ## Adaptive Lasso
  if (tenfold) {
    cv.lasso_mod_2 <- cv.glmnet(as.matrix(select(train_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), train_o$firstsecondpass_scen, alpha=1, parallel=TRUE, standardize=TRUE, type.measure='auc', penalty.factor=w3, nfolds = 10)
  }
  if (fivefold) {
    cv.lasso_mod_3 <- cv.glmnet(as.matrix(select(train_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), train_o$firstsecondpass_scen, alpha=1, parallel=TRUE, standardize=TRUE, type.measure='auc', penalty.factor=w3, nfolds = 5)
  }  
  if (threefold) {
    cv.lasso_mod_4 <- cv.glmnet(as.matrix(select(train_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), train_o$firstsecondpass_scen, alpha=1, parallel=TRUE, standardize=TRUE, type.measure='auc', penalty.factor=w3, nfolds = 3)
  }   
}
stopCluster(cl) 
```
...
cat("Minimum lamda 10 fold cv:", cv.lasso_mod_2$lambda.min, "\n")
plot(cv.lasso_mod_2, xvar="lambda", label=TRUE)
title("Lasso cv 10", line = -1)
cat("Minimum lamda  5 fold cv:", cv.lasso_mod_3$lambda.min, "\n")
plot(cv.lasso_mod_3, xvar="lambda", label=TRUE)
title("Lasso cv 5", line = -1)
cat("Minimum lamda  3 fold cv:", cv.lasso_mod_4$lambda.min, "\n")
plot(cv.lasso_mod_4, xvar="lambda", label=TRUE)
...
library(e1071)
# Evaluation with test data set
yhat <- predict(cv.lasso_mod_2, as.matrix(select(test_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), type = "class", s = "lambda.min")
yhat_prob <- fn_norm_zo(yhat)        # normalize predicte values
yhat_label <- as.factor(prob_to_class(yhat_prob, 0.5))
...
library(e1071)
# Evaluation with test data set
yhat <- predict(cv.lasso_mod_3, as.matrix(select(test_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), type = "class", s = "lambda.min")
yhat_prob <- fn_norm_zo(yhat)        # normalize predicte values
yhat_label <- as.factor(prob_to_class(yhat_prob, 0.5))
...
library(e1071)
# Evaluation with test data set
yhat <- predict(cv.lasso_mod_4, as.matrix(select(test_o, -c(NTHID, SFILENAME, DTINSERT, SID, SARTIKELNR, DTDATUM, SPLATZNR, SERGEBNIS, BEFUND_clean, pseudo, firstpass_scen, secondpass_scen, firstsecondpass_scen, xpass))), type = "class", s = "lambda.min")
yhat_prob <- fn_norm_zo(yhat)        # normalize predicte values
yhat_label <- as.factor(prob_to_class(yhat_prob, 0.5))
