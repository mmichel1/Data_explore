...
Remove duplicates, generate one combined rawframe for ICT measurements:
```{r, echo = FALSE}
# check for double measurements - 258 cycles of two A5E02758387 - files
cat("check for double measurements - duplicated measurement cycles of two A5E02758387 - files: ", 
...
cat("removed duplicated single measurements: ", 
...
cat("remove duplicates in Q Data: ", sum(duplicated(q_daten)), "items \n")  
...
cat(nrow(q_daten), "items remaining\n")  
...
cat("In total", nrow(rawframe), "single measurement points after removing Soll-Istwerte lines\n\n")  
...
Following two charts show the distribution of unsuccessful measurement cycles over all variants and specific per variant.
