...
# ====================== Parameters ==============
rel_fpath  <- "./data/OGT/" # relative directory where original data is stored
...
rel_fpath_output <- "./data/OGT/" # relative directory where outputs are stored
...
This section shows boxplots, histograms and the summary statistics of all numerical variablesas well as related comments and descriptions which are extracted from the data control file.
...
Probelm bei Facetierung von Histogrammen: Countwerte inkonsistent!!!
